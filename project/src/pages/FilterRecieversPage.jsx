...
const FilterRecieversPage = ({ deliverGoldData }) => {
  ...
  const handleSelectedSheet = async (sheetId) => {
    try {
      ...
      setBronzeData(null);
      const rangesD1 = "ranges=D1-TOP!A1:G1000&ranges=D1-BOTTOM!A1:G1000";
      const rangesD2 = "ranges=D2-TOP!A1:G1000&ranges=D2-BOTTOM!A1:G1000";
      const rangesD3 = "ranges=D3-TOP!A1:G1000&ranges=D3-BOTTOM!A1:G1000";
      const rangesNaia = "ranges=NAIA!A1:G1000";
